            ...
            <div class="login-box" style="margin-top: 3rem;margin-bottom: 3rem;">
                ...
                <form action="{{ route('login') }}" method="post">
                    ...
                    <div class="text-center">
                        <button class="btn btn-primary" style="margin-top: 3rem">Login Now</button>

                        <div class="my-2" style="margin-top: 2rem">or</div>

                        <a href="{{ route('student.register') }}" type="submit" style="margin-top: 2rem"
                            formaction="register.html" class="btn btn-outline-primary">
                            Register Now
                        </a>
                    </div>
