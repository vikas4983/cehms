...
@section('content')
    ...
    <div
        ...
        <form id="addTestimonial" action="{{ route('testimonials.store') }}" method="POST" class="d-flex flex-column p-20"
            enctype="multipart/form-data">
            @csrf
            <div class="row g-3">
                <div class="col-sm-4">
                    <div class="">
                        <label for="testimonialName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Name
                        </label>
